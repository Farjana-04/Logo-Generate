...
//   });
//   test("test white circle", () => {
//     const circle = new Circle("SVG", "white", "white");
//     expect(circle.shapeBackgroundColor).toBe("white");
//   });
//   test("test blue circle", () => {
//     const circle = new Circle("SVG", "white", "blue");
//     expect(circle.shapeBackgroundColor).toBe("blue");
//   });
